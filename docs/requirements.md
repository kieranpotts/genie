...
The `./run/install` script requires Bash. If you don't have this, no worries, you'll just have to copy the extensions into `~/.pi/agents/extensions/` yourself. See the [Pi docs][pi-docs].
